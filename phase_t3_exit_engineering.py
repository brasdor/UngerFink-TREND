# -*- coding: utf-8 -*-
"""
Phase T3 — Trend Following Exit Engineering
Author: Jean / ChatGPT

Purpose
-------
Take the Phase T2 core trend concept and test simple Unger-style exit engineering:
...
- Initial stop = 2 ATR
- Breakeven after +1R
- Chandelier trailing stop activated after +2R
- Closed candles only
- No real orders. Research/backtest only.

Outputs
-------
data/research_trend_t3/phase_t3_exit_engineering_trades.csv
data/research_trend_t3/phase_t3_exit_engineering_equity.csv
data/research_trend_t3/phase_t3_exit_engineering_summary.csv
data/research_trend_t3/phase_t3_exit_engineering_asset_summary.csv
data/research_trend_t3/phase_t3_exit_engineering_stop_timeline.csv
...
OUT_DIR = BASE_DIR / "data" / "research_trend_t3"
...
def simulate_symbol_timeframe(symbol: str, timeframe: str, df: pd.DataFrame) -> Tuple[List[Dict], List[Dict]]:
    ...
    for i in range(warmup, len(df)):
        ...
        if in_pos and pos is not None:
            ...
            # Breakeven activation after +1R.
            be_activated_this_bar = False
            if not pos["breakeven_active"] and pos["mfe_r"] >= BREAKEVEN_TRIGGER_R:
            ...
            # Chandelier activation after +2R.
...
def main() -> None:
    print("=" * 80)
    print("Phase T3 — Trend Exit Engineering")
    print("70 asset default | 2H/4H | Donchian/EMA entry | BE +1R | Chandelier +2R")
    print("=" * 80)
    ...
    trades_path = OUT_DIR / "phase_t3_exit_engineering_trades.csv"
    equity_path = OUT_DIR / "phase_t3_exit_engineering_equity.csv"
    summary_path = OUT_DIR / "phase_t3_exit_engineering_summary.csv"
    asset_summary_path = OUT_DIR / "phase_t3_exit_engineering_asset_summary.csv"
    timeline_path = OUT_DIR / "phase_t3_exit_engineering_stop_timeline.csv"
    ...
    print("\n" + "=" * 80)
    print("DONE — Phase T3 outputs written:")
    print(trades_path)
    print(equity_path)
    print(summary_path)
